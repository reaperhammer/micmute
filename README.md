...
<img width="366" height="122" alt="image" src="https://github.com/user-attachments/assets/77b65a60-e687-4b6f-84f0-29c0e3754cc3" />
...
<img width="440" height="518" alt="image" src="https://github.com/user-attachments/assets/78d92805-ecf9-4491-b75a-df901f668908" />
...
1. **Download**
   ...
   - Extract the archive to C:\micmute (or any path of your choosing)
   - Run **`buildme.bat`** to generate the exe file
   - 

2. **Run**
   - Start **`MicMute2.exe`** from **`C:\micmute\micmute\MicMute2.exe`**
...
- Length: keep files under 2 seconds to avoid noticeable delay
...
### Notes
- **Icons**: Ensure `mic_on.ico` and `mic_off.ico` are present in `C:\micmute\micmute`, as they are required for the tray icon
- **Configuration file**: The microphone state is stored in **`C:\micmute\micmute\MicMuteConfig.txt`**
